...
pe "cfn-lint ./demo1-3/bad-template.yaml"

wait
clear

pe "cfn-lint ./demo1-3/good-template.yaml"
...
pe "checkov -f ./demo1-3/bad-template.yaml --framework cloudformation"

wait
clear

pe "checkov -f ./demo1-3/good-template.yaml --framework cloudformation"
...
pe "cfn-guard validate -r ./demo1-3/s3-rules.guard -d ./demo1-3/bad-template.yaml"

wait
clear

pe "cfn-guard validate -r ./demo1-3/s3-rules.guard -d ./demo1-3/good-template.yaml"
...
# ============================================================================
# Demo 8: Terraform Native Testing Framework
# ============================================================================
if [ $START_DEMO -le 8 ]; then

cd "$DEMO_DIR"

echo "# === Demo 8: Terraform Native Testing Framework ==="
...
echo "# --- Mock test: no AWS credentials needed ---"
pe "terraform test -filter=tests/mock.tftest.hcl"

wait
clear

echo "# --- Integration test: deploys real resources ---"
pe "AWS_PROFILE=cecil-personal terraform test -filter=tests/s3_bucket.tftest.hcl"
